...
import { ANCAntenatalVisitUpdate } from './anc_antenatal_visit_update.request';
import { ANCOptionalInvestigationUpdate } from './anc_optional_investigations_update.request';

export class AntenatalCareUpdate {
  @ApiProperty({
  ...
  @Type(() => ANCAntenatalVisitUpdate)
  antenatalVisits?: ANCAntenatalVisitUpdate[];

  @ApiProperty({
    type: [ANCOptionalInvestigationUpdate],
    description: 'List of antenatal visits',
  })
  @IsOptional()
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => ANCOptionalInvestigationUpdate)
  optionalInvestigations?: ANCOptionalInvestigationUpdate[];
}
