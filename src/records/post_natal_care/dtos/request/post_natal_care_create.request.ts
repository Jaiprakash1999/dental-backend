...
import { PNCPostpartumCareCreate } from './pnc_postpartum_care_create.request';

export class PostNatalCareCreate {
  ...
  @ApiProperty({
    ...
    type: [PNCPostpartumCareCreate],
  })
  @ValidateNested({ each: true })
  @IsArray()
  @ArrayNotEmpty()
  @Type(() => PNCPostpartumCareCreate)
  postpartumCareRecords: PNCPostpartumCareCreate[];
}
